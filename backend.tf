terraform {
  backend "azurerm" {
    ...
    storage_account_name = "terraform9804"                                 # Can be passed via `-backend-config=`"storage_account_name=<storage account name>"` in the `init` command.
...
// this is a demo change for testing remote origin
